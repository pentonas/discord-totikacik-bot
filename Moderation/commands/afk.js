...
class AFK extends Command {
    ...
    async run(message, args, data) {
        ...
        if(regex.exec(message.content)) return message.channel.send(`İsmine Link Koyamazsın!`);
        if (message.content.includes("@here") || message.member.manageable || message.member.displayName.length > 28 || message.content.includes("@everyone") || message.content.includes("<@&694861871475458048>") || message.content.includes("694861871475458048")) return
