...
const role_log_chat = clientayar.role_log_chat
...
class Rolyonet extends Command {
    ...
    async run(message, args, level) {
        ...
        if (!message.member.roles.cache.some(r => [clientayar.botCommandhammer, clientayar.registerhammer].includes(r.id)) && !message.member.hasPermission("ADMINISTRATOR")) return
